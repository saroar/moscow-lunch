==Lunch Ordering
Each company that uses the services of delivery meals, sooner or later, comes to the great and original idea to develop their own
service to order a lunch. Many start, but only few of them bring it to the end. The objective of this task is to develop very small MVP,
which could be taken and used already in production


We will try to simplify the problem as much as possible. Please find User Stories below. Let’s assume that there is only one organization
in the application, all users belong to it.
...
==Recommended technologies
  This is recommended Tecnology you can you use but if you something better then this please feel free skip this :)
 ­ Rails 4+, devise, twitter bootstrap, haml, simple_form, carrierwave,
  rspec, capybara
